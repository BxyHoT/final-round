...
function showAll() {
  if (itemsHiden) {
    ...
    btnShowAll1.style.background = 'url("img/expand180.svg") no-repeat 0 50%';
    btnShowAll1.style.margin = '46px 0 0 0';
  }
  else {
    responseOnWindowWidth();
    btnShowAll1.innerText = 'Показать всё';
    btnShowAll1.style.background = 'url("img/expand.svg") no-repeat 0 50%';
...
function showAll2() {
  if (itemsHiden2) {
    ...
    btnShowAll2.style.background = 'url("img/expand180.svg") no-repeat 0 50%';
    btnShowAll2.style.margin = '46px 0 0 0';
  }
  else {
    responseOnWindowWidth2();
    btnShowAll2.innerText = 'Показать всё';
    btnShowAll2.style.background = 'url("img/expand.svg") no-repeat 0 50%';
...
function readMore() {
  ...
  if (mainTextItem4.classList.contains('hidden')) {
    ...
    btnReadMore.style.background = 'url("img/expand180.svg") no-repeat 0 50%';
    ...
    btnReadMore.style.background = 'url("img/expand.svg") no-repeat 0 50%';
